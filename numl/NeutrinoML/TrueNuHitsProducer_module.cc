////////////////////////////////////////////////////////////////////////
// Class:       TrueNuHitsProducer
// Plugin Type: producer (art v3_06_03)
// File:        TrueNuHitsProducer_module.cc
//
...
class TrueNuHitsProducer : public art::EDProducer {
public:
  explicit TrueNuHitsProducer(fhicl::ParameterSet const& p);
  // The compiler-generated destructor is fine for non-base
  // classes without bare pointers or other resource use.

  // Plugins should not be copied or assigned.
  TrueNuHitsProducer(TrueNuHitsProducer const&) = delete;
  TrueNuHitsProducer(TrueNuHitsProducer&&) = delete;
  TrueNuHitsProducer& operator=(TrueNuHitsProducer const&) = delete;
  TrueNuHitsProducer& operator=(TrueNuHitsProducer&&) = delete;
...
TrueNuHitsProducer::TrueNuHitsProducer(fhicl::ParameterSet const& p)
  : EDProducer{p},
...
void TrueNuHitsProducer::produce(art::Event& e)
{
...
DEFINE_ART_MODULE(TrueNuHitsProducer)
